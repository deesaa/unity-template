...
public class GameObjectFabric
{
    ...
    public void CreateSimpleColorable(Vector3 position, Quaternion rotation)
    {
        ...
        entity.GetAndFire<ColorComponent>().Color = Configuration.IntialColorableObjectsColor;
        entity.GetAndFire<TransformComponent>() = new TransformComponent()
        {
            WorldPosition = position,
            Rotation = rotation,
            Scale = Configuration.ColorableUnitsScale
        };
    }
    ...
    public void CreatePlayer(Vector3 position, Quaternion rotation)
    {
        ...
        entity.GetAndFire<ColorComponent>().Color = Configuration.IntialPlayerColor;
